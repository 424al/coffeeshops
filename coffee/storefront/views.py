...
from .logical_references import (
...
class SuperAdminLocationDirectory(LoginRequiredMixin,ListView):
    model = StoreFront
    template_name = 'admin/location_directory.html'

    def get_context_data(self, *, object_list=None, **kwargs):
        context = super(SuperAdminLocationDirectory, self).get_context_data(**kwargs)
        context['locations'] = StoreFront.objects.filter().count()
